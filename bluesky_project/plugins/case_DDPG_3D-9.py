...
from plugins.Multi_Agent.DDPG_3DNine import DDPG
...
def init_plugin():
    ...
    os.makedirs('output/DDPG/DDPG3D-13/scenarios', exist_ok=True)
    ...
    if written == 1:
        SCN_File = f"output/DDPG/DDPG3D-13/scenarios/{episode_num}.scn"
...
def reset():
    ...
    stats_dir = 'output/DDPG/DDPG3D-13'
    ...
    reward_list = [0 for _ in range(max_ac)]
    if episode_num % 10 == 0:
        agent_manager.save_models(f"output/DDPG/DDPG3D-13/DDPG")
