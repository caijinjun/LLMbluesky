...
from plugins.Multi_Agent.DDPG_3DTwo import DDPG
...
def reset():
    ...
    stats_dir = 'output/DDPG/DDPG3D-2'
    ...
    reward_list = [0 for _ in range(max_ac)]
    if episode_num % 10 == 0:
        agent_manager.save_models(f"output\\DDPG\\DDPG3D-2\\DDPG")
